        ...
        Storefront config = Storefront.builder()
                ...
                .heroSection(Storefront.HeroSection.builder()
                        .campaigns(java.util.stream.Stream.generate(() -> 
                                Storefront.Campaign.builder().largeImageUrl(null).smallImageUrl(null).title("Fresh Bakery").description("Delicious goods").build()
                        ).limit(5).toList())
                        .build())
                ...
                .specialOfferSection(Storefront.SpecialOfferSection.builder()
                        .offers(List.of(
                                Storefront.SpecialOffer.builder()
                                        .imageUrl("/images/hero_cake.png")
                                        .title("Special Cake")
                                        .description("Get 20% off your first cake order!")
                                        .build()
                        ))
                        .build())
